...
abstract class FragmentationSupportActivity : RxLifecycleMvRxActivity(), ISupportActivity {
    ...
    fun loadRootFragment(
        ...
        containerId: Int = getContextViewId(),
     ...
     */
    fun start(toFragment: ISupportFragment, @LaunchMode launchMode: Int = ISupportFragment.STANDARD) {
